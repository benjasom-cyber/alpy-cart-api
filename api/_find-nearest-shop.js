...
function expandBlob(raw) {
  ...
  // 26 January corpus, including one whose subject line was "Ski rent in
  // Pinzolo" and whose extraction had already produced {"resort":"Pinzolo"}.
  //
  // Accepting both spellings here fixes it without touching the connector.
  const ALIAS = {
